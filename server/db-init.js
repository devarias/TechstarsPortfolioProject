...
const seedDays = async (client) => {
  ...
  `;
  await client.query(sql, ['Monday']);
  await client.query(sql, ['Tuesday']);
  await client.query(sql, ['Wednesday']);
  await client.query(sql, ['Thursday']);
  await client.query(sql, ['Friday']);
};
...
const seedBlocks = async (client) => {
  const sql = `
    ...
    `;
  await client.query(sql, ['AM']);
  await client.query(sql, ['PM']);
};
...
const seedSlots = async (client) => {
  const sql = `
    ...
    `;
  await client.query(sql, ['08:00:00']);
  await client.query(sql, ['08:20:00']);
  await client.query(sql, ['08:40:00']);
  await client.query(sql, ['09:00:00']);
  await client.query(sql, ['09:20:00']);
  await client.query(sql, ['09:40:00']);
  await client.query(sql, ['10:00:00']);
  await client.query(sql, ['10:20:00']);
  await client.query(sql, ['10:40:00']);
  await client.query(sql, ['11:00:00']);
  await client.query(sql, ['11:20:00']);
  await client.query(sql, ['11:40:00']);
  await client.query(sql, ['13:10:00']);
  await client.query(sql, ['13:30:00']);
  await client.query(sql, ['13:50:00']);
  await client.query(sql, ['14:10:00']);
  await client.query(sql, ['14:30:00']);
  await client.query(sql, ['14:50:00']);
  await client.query(sql, ['15:10:00']);
  await client.query(sql, ['15:30:00']);
  await client.query(sql, ['15:50:00']);
  await client.query(sql, ['16:10:00']);
  await client.query(sql, ['16:30:00']);
  await client.query(sql, ['16:50:00']);
};
