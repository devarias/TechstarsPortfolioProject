...
const Page = () => {
  ...
  const viewComponents = [
    ...
    {component: null, classes: null, route: null}, 
    {component: null, classes: null, route: null}, 
    {component: <UploadFile setResSchedule={setResSchedule} setView={setView}
     setViewSelect={setViewSelect}/>, classes:'charts', route: '/GenerateMeetings'}, 
    {component: <TableSchedule resSchedule={resSchedule}/>, classes: 'table', route: '/MeetingsTable'},
          ...
          <Row className='content'>
            <Switch>
              <Route path={viewComponents[view].route}>
                <Col span={24} className={viewComponents[view].classes}>{viewComponents[view].component}</Col> 
              </Route>
            </Switch>
          </Row>
        </Content>
