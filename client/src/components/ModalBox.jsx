    ...
    <>
      <Modal title="Result Summary" visible={props.isModalVisible} onOk={handleOk} onCancel={handleCancel} cancelButtonProps={{ style: { display: 'none' } }}>
        <div className='modalBox'>
          ...
          The score of how prepared is <span className={codeColor[mentorRanking -1]}>{mentorRanking === 6 ? 'None' : mentorRanking}</span>.<br/>
          ...
          The score of helpfulness is <span className={codeColor[companyRanking - 1]}>{companyRanking === 6 ? 'None' : companyRanking}</span>.<br/>
