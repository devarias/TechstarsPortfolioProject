...
function ModalSurvey(props) {
 ...
 const showDescription = () => {
   ...
   let pendingArray = props.modalContent.total.filter(element => { if (!props.modalContent.answered.includes(element)) { return <li>{element}</li>} })
  ...
  return(
     <Modal title="Survey status description." visible={props.isModalVisible} onOk={handleOk} onCancel={handleCancel} cancelButtonProps={{ style: { display: 'none' } }}>
        <div className='modalBox'>
         {props.modalContent.client ?
